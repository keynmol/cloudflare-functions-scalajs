...
$c_Lapp_app$package$.prototype.request_headers__Lcom_indoorvivants_cloudflare_cloudflareWorkersTypes_EventContext__Lcom_indoorvivants_cloudflare_cloudflareWorkersTypes_global_Response = (function(context) {
  var str = $ct_scm_StringBuilder__(new $c_scm_StringBuilder());
  context.request.headers.forEach(((this$1, str$2) => (function(value, key, _$2) {
    var value$1 = $as_T(value);
    var key$1 = $as_T(key);
    str$2.append__T__scm_StringBuilder((((("Keys: " + key$1) + ", value: ") + value$1) + "\n"))
  }))(this, str));
  return new Response(("hello, world. Your request comes with \n" + str.scm_StringBuilder__f_underlying.jl_StringBuilder__f_java$lang$StringBuilder$$content))
});
$c_Lapp_app$package$.prototype.request_method__Lcom_indoorvivants_cloudflare_cloudflareWorkersTypes_EventContext__Lcom_indoorvivants_cloudflare_cloudflareWorkersTypes_global_Response = (function(context) {
  return new Response(("Your request came via " + $as_T(context.request.method)))
});
